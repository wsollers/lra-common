...
\input{common/boxes/formal-definition}
\input{common/boxes/formal-definitional-root}
\input{common/boxes/formal-axiom}
\input{common/boxes/formal-theorem}
\input{common/boxes/formal-lemma}
\input{common/boxes/formal-proposition}
\input{common/boxes/formal-corollary}
\input{common/boxes/model}
...
\newtcolorbox{restatementbox}[1]{
  ...
  boxed title style={boxrule=0.45pt, arc=2pt, colframe=black!18, colback=black!5},
...
\newtcolorbox{formalizationrecord}[1]{%
  enhanced,
  breakable,
  colback=structuretheorybox,
  colframe=structuretheoryborder,
  coltitle=black,
  colbacktitle=structuretheoryborder!18!white,
  ...
  boxed title style={
    ...
    arc=2pt,
    colframe=structuretheoryborder,
    colback=structuretheoryborder!18!white,
    top=3pt,
    bottom=3pt,
    left=5pt,
    right=5pt
...
\newtcblisting{leancode}{%
  ...
  listing only,
  colback=white,
  colframe=structuretheoryborder!35!white,
  boxrule=0.4pt,
  arc=1pt,
  boxsep=0pt,
  left=6pt,
...
\newcommand{\FormalizationSource}[1]{\textbf{Source anchor:} #1.\par}
\newcommand{\Formalizes}[1]{\textbf{Formalizes:} \Cref{#1}.\par}
\newcommand{\LeanDeclaration}[1]{\textbf{Lean declaration:} \texttt{#1}.\par}
\NewDocumentCommand{\Unverified}{o}{}

\newcommand{\NoLocalDependencies}{}
\newcommand{\DefinitionalRoot}{}
